...
public class FavoriteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View fav_fragment = inflater.inflate(R.layout.fragment_favorite, container, false);
        ...
        ((Spinner) fav_fragment.findViewById(R.id.sp_fav_filter_type)).setAdapter(adapter);
        ...
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ((Spinner) fav_fragment.findViewById(R.id.sp_fav_filter_district)).setAdapter(adapter);
        ...
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ((Spinner) fav_fragment.findViewById(R.id.sp_fav_filter_rating)).setAdapter(adapter);

        LinearLayout row_toilet = fav_fragment.findViewById(R.id.lnl_fav_toilet);
